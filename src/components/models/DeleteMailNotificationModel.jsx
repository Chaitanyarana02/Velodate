...
const DeleteMailNotificationModel = ({
  isOpenDeleteNotification,
  closeModalDeleteNotification,
  isDeleteMailNotificationData,
}) => {
  ...
  const handleDelete = async () => {
    try {
      handleCloseModal();
      // console.log(isDeleteMailNotificationData);
      setScreenLoading(true);

      const response = await axios.delete(
        `admin/users/email-notification/${isDeleteMailNotificationData.id}`
      );
          ...
          <div className="bg-[#3D3B35] p-12 rounded-lg shadow-lg relative z-50 md:w-1/2 lg:w-2/6">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-center text-[#FFFFFF] text-[16px] font-normal mt-2 mb-16">
                Are you sure you want to delete this mail notification.This
...
DeleteMailNotificationModel.propTypes = {
  isOpenDeleteNotification: PropTypes.bool.isRequired,
  closeModalDeleteNotification: PropTypes.func.isRequired,
  isDeleteMailNotificationData: PropTypes.object.isRequired,
};

export default DeleteMailNotificationModel;
