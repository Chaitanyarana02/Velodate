          ...
          <div className="w-full">
            ...
            {reprotData.slice(startIndex, endIndex).map((query, index) => (
              <div
                ...
                className="w-full bg-[#3D3B35] rounded-2xl grid grid-cols-3 md:grid-cols-4 gap-4 p-2 my-[0.20rem] hover:border hover:border-[#D8A409] cursor-pointer items-center"
